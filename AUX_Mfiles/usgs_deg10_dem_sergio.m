function [salti, landfrac] = usgs_deg10_dem_sergio(lat, lon, wgf);

% copied from /asl/matlib/science/usgs_deg10_dem.m
% and basically replaces /asl/data/usgs/world_grid_deg10.mat with
%                        /asl/data/usgs/world_grid_deg10_v2.mat
%
...
if(exist('wgf','var'))
  ...
  disp('loading in /asl/data/usgs/world_grid_deg10_v2.mat');
