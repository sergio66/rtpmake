function [xhd0,xpdmat] = get_richardson_number_levels_v2(hd0,ha0,pd0,pa0);
...
for ii = 1 : nn
  ...
  %% see get_richardson_number_levels_v3.m
...
elseif iVers_Ri == 1
  ...
  %% notice use of t2m nstead of skt!!!, see get_richardson_number_levels_v3.m
  %% [pblhx,Ribx,junkx] = compute_pblh_Ri(xpdmat.zalts(1:NNlevs,ii),xpdmat.ptemp(1:NNlevs,ii),xpdmat.plevs(1:NNlevs,ii),...
  %%                                      xpdmat.gas_1(1:NNlevs,ii),xpdmat.u(1:NNlevs,ii),xpdmat.v(1:NNlevs,ii),...
  ...
  if ii == 12150
    ...
    figure(9); scatter_coast(xpdmat.rlon,xpdmat.rlat,20,pd0.pblh);                                     title('ERA5 or ECM raw PBLH [km] '); caxis([0 6])              
