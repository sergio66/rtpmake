...
if iInterp <= 0
  if iERAorECM == 1
    ...
    fout = ['cloudy_cris_fsr_era_sarta_baum_ice' yymmdddggstr '*.rtp'];
    fout = ['cloudy_cris_fsr_era_sarta_baum_ice' yymmdddggstr num2str(gg,'%03d') '.rtp'];
  elseif iERAorECM == -1
  ...
  if iERAorECM == 1
    ...
    fout = ['interp_analysis_cloudy_cris_fsr_era_sarta_baum_ice' yymmdddggstr '*.rtp'];
    fout = ['interp_analysis_cloudy_cris_fsr_era_sarta_baum_ice' yymmdddggstr num2str(gg,'%03d') '.rtp'];
  elseif iERAorECM == -1
