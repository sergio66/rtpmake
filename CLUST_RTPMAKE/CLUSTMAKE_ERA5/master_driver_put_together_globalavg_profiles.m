...
figure(3); scatter_coast(pold.rlon,pold.rlat,50,pold.stemp-allprof11.stemp); caxis([-1 +1]*20)
...
figure(1); pcolor_coast(allprof11.rlon,allprof11.rlat,allprof11.rtime); colormap jet
...
figure(2); scatter_coast(allprof11.rlon,allprof11.rlat,50,allprof11.stemp-allprof10.stemp); colormap usa2; caxis([-1 +1]*2); title('stemp : Q(1.00)-Q(0.97)')
figure(3); scatter_coast(allprof11.rlon,allprof11.rlat,50,allprof11.stemp-allprof09.stemp); colormap usa2; caxis([-1 +1]*2); title('stemp : Q(1.00)-Q(0.95)')
figure(4); scatter_coast(allprof11.rlon,allprof11.rlat,50,allprof11.stemp-allprof06.stemp); colormap usa2; caxis([-1 +1]*2); title('stemp : Q(1.00)-Q(0.90)')
figure(5); scatter_coast(allprof11.rlon,allprof11.rlat,50,allprof11.stemp-allprof07.stemp); colormap usa2; caxis([-1 +1]*2); title('stemp : Q(1.00)-Q(0.80)')

figure(1); pcolor_coast(allprof11.rlon,allprof11.rlat,allprof11.stemp); colormap jet
figure(2); pcolor_coast(allprof11.rlon,allprof11.rlat,allprof11.stemp-allprof10.stemp); colormap usa2; caxis([-1 +1]*2); title('stemp : Q(1.00)-Q(0.97)')
figure(3); pcolor_coast(allprof11.rlon,allprof11.rlat,allprof11.stemp-allprof09.stemp); colormap usa2; caxis([-1 +1]*2); title('stemp : Q(1.00)-Q(0.95)')
figure(4); pcolor_coast(allprof11.rlon,allprof11.rlat,allprof11.stemp-allprof06.stemp); colormap usa2; caxis([-1 +1]*2); title('stemp : Q(1.00)-Q(0.90)')
figure(5); pcolor_coast(allprof11.rlon,allprof11.rlat,allprof11.stemp-allprof07.stemp); colormap usa2; caxis([-1 +1]*2); title('stemp : Q(1.00)-Q(0.80)')
...
figure(1); plot(1:64,woo11,1:64,woo10,1:64,woo09,1:64,woo08,1:64,woo07); title('waterOD')
...
figure(2); plot(1:64,woo11,1:64,woo10,1:64,woo09,1:64,woo08,1:64,woo07); title('water frac')
...
figure(3); plot(1:64,woo11,1:64,woo10,1:64,woo09,1:64,woo08,1:64,woo07); title('water top (mb)'); set(gca,'ydir','reverse');
