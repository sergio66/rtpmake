...
if length(baddy) > 0
  ...
  hold on; plot(sum(reshape(iaBad,72,64),1),1:64,'linewidth',2); plot(sum(reshape(iaBad,72,64),1),1:64,'linewidth',2); plot(sum(reshape(iaBad,72,64),1),1:64,'linewidth',2); hold off
