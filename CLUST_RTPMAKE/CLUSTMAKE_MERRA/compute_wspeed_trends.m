...
saver = ['save merra2_wspeed_2002_09_' num2str(yyEnd) '_' num2str(mmEnd,'%02d') '.mat  yysave mmsave wspeedsave stempsave tccsave trend trend_err yyEnd mmEnd'];
eval(saver)
...
saver = ['save merra2_wspeed_2002_09_' num2str(yyEnd) '_' num2str(mmEnd,'%02d') '.mat  yysave mmsave wspeedsave stempsave tccsave trend trend_err emissivitychange yyEnd mmEnd'];
eval(saver)
