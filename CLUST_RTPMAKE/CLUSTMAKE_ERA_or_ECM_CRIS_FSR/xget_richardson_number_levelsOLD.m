...
for ii = 1 : nn
  ...
  if ii == 1 & iVers_Ri == 1
    ...
    plot(xxpdmat.Ri(1:NNlevs,ii),xpdmat.zalts(1:NNlevs,ii)/1000,'gx-',xpdmat.Ri(1:NNlevs,ii),xpdmat.zalts(1:NNlevs,ii)/1000,'bx-',axpdmat.Ri(1:NNlevs,ii),xpdmat.zalts(1:NNlevs,ii)/1000,'rx-'); axis([-40 120 0 10])
