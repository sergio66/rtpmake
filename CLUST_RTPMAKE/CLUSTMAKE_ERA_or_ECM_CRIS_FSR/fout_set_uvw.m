...
if iInterp <= 0  
  if iERAorECM == 1
    ...
    fmatout = ['uvw_cloudy_cris_fsr_era_sarta_baum_ice' yymmdddggstr '*.rtp'];
    fmatout = ['uvw_cloudy_cris_fsr_era_sarta_baum_ice' yymmdddggstr num2str(gg,'%03d') '.rtp'];
  elseif iERAorECM == -1
  ...
  if iERAorECM == 1
    ...
    fmatout = ['interp_analysis_cloudy_cris_fsr_era_sarta_baum_ice' yymmdddggstr '*.rtp'];
    fmatout = ['interp_analysis_cloudy_cris_fsr_era_sarta_baum_ice' yymmdddggstr num2str(gg,'%03d') '.rtp'];
  elseif iERAorECM == -1
...
if iInterp <= 0  
  if iERAorECM == 1
    ...
    fmatout = ['uvw_cloudy_cris_fsr_era_sarta_baum_ice' yymmdddggstr '*.mat'];
    fmatout = ['uvw_cloudy_cris_fsr_era_sarta_baum_ice' yymmdddggstr num2str(gg,'%03d') '.mat'];
  elseif iERAorECM == -1
  ...
  if iERAorECM == 1
    ...
    fmatout = ['interp_analysis_uvw_cloudy_cris_fsr_era_sarta_baum_ice' yymmdddggstr '*.mat'];
    fmatout = ['interp_analysis_uvw_cloudy_cris_fsr_era_sarta_baum_ice' yymmdddggstr num2str(gg,'%03d') '.mat'];
  elseif iERAorECM == -1
