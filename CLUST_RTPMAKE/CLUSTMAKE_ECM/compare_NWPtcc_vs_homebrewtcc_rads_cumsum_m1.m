...
while ii0 > 0 & ii0 < 241
  f0 = ['/asl/s1/sergio/rtp/rtp_airicrad_v6/2018/10/31/cloudy_airs_l1b_ecm_sarta_baum_ice.2018.10.31.' num2str(ii0,'%03d') '_cumsum_-1.rtp'];
  fx = ['/asl/s1/sergio/rtp/rtp_airicrad_v6/2018/10/31/cloudy_airs_l1b_ecm_sarta_baum_ice.2018.10.31.' num2str(ii0,'%03d') '_pert_tcc_model_1_cumsum_-1.rtp'];
...
for ii = 1 : 240
  ...
  f0 = ['/asl/s1/sergio/rtp/rtp_airicrad_v6/2018/10/31/cloudy_airs_l1b_ecm_sarta_baum_ice.2018.10.31.' num2str(ii,'%03d') '_cumsum_-1.rtp'];
  fx = ['/asl/s1/sergio/rtp/rtp_airicrad_v6/2018/10/31/cloudy_airs_l1b_ecm_sarta_baum_ice.2018.10.31.' num2str(ii,'%03d') '_pert_tcc_model_1_cumsum_-1.rtp'];
...
fprintf(1,'\n');
save compare_NWPtcc_vs_homebrewtcc_rads_cumsum_m1.mat t*1231* stemp* tcc* gran rlon rlat bias* std* mean*
a = load('compare_NWPtcc_vs_homebrewtcc_rads_cumsum_m1.mat')
