...
% clustcmd -L clust_make_ecmcloudrtp_sergio_sarta_NADIRFOV.m yy0mm0dd0:yyEmmEddE
%
% otherwise when happy
% clustcmd -q medium -n 64 -p 4 clust_make_ecmcloudrtp_sergio_sarta_NADIRFOV.m yy0mm0dd0:yyEmmEddE
%
% or
% clustcmd -q long_contrib -n 64 -p 4 clust_make_ecmcloudrtp_sergio_sarta_NADIRFOV.m yy0mm0dd0:yyEmmEddE
...
icestr = ['cloudy_airs_l1b_ecm_nadirfov' icestr '.'];
