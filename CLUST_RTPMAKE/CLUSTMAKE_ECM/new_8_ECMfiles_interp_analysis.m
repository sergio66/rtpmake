...
boo = find(xhhh >= 0 & xhhh <= 3);
  tB1(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),0.0);
  tB2(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),3.0);
  booX(boo) = 1;
boo = find(xhhh > 3 & xhhh <= 6);
  tB1(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),3.0);
  tB2(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),6.0);      
  booX(boo) = 2;
boo = find(xhhh > 6 & xhhh <= 9);
  tB1(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),6.0);
  tB2(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),9.0);      
  booX(boo) = 3;
boo = find(xhhh > 9 & xhhh <= 12);
  tB1(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),9.0);
  tB2(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),12.0);
  booX(boo) = 4;
boo = find(xhhh > 12 & xhhh <= 15);
  tB1(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),12.0);
  tB2(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),15.0);
  booX(boo) = 5;
boo = find(xhhh > 15 & xhhh <= 18);
  tB1(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),15.0);
  tB2(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),18.0);
  booX(boo) = 6;
boo = find(xhhh > 18 & xhhh <= 21);
  tB1(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),18.0);
  tB2(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),21.0);
  booX(boo) = 7;
boo = find(xhhh > 21 & xhhh <= 24);
  tB1(boo) = utc2taiSergio(xyyh(boo),xmmh(boo),xddh(boo),21.0);
...
plot(frac1); title('frac1 in new\_8\_ECMfiles\_interp\_analysis.m'); pause(1)
