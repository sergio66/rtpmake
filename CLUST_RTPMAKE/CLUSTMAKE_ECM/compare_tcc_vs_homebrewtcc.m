...
fective radius to particle diameter.  At present, the same optical
...
disp(' >>>>>>>  see rttovs_mro : plot(prof_era.tcc,lastbutone,prof_era.tcc,prof_era.tcc);; axis([0 1 0 1]) is VERY GOOD')
disp(' >>>>>>>  see rttovs_mro : plot(prof_era.tcc,lastbutone,prof_era.tcc,prof_era.tcc);; axis([0 1 0 1]) is VERY GOOD')
disp(' >>>>>>>  see rttovs_mro : plot(prof_era.tcc,lastbutone,prof_era.tcc,prof_era.tcc);; axis([0 1 0 1]) is VERY GOOD')
