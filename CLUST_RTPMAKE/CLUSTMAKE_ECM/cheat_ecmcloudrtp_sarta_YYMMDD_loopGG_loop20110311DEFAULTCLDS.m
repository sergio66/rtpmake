...
% clustcmd -L cheat_ecmcloudrtp_sarta_YYMMDD_loopGG_loop20110311DEFAULTCLDS.m 001:240
%
% otherwise when happy
% clustcmd -q medium -n 64 -p 4 cheat_ecmcloudrtp_sarta_YYMMDD_loopGG_loop20110311DEFAULTCLDS.m 001:240
%
% or
% clustcmd -q long_contrib -n 64 -p 4 cheat_ecmcloudrtp_sarta_YYMMDD_loopGG_loop20110311DEFAULTCLDS.m 001:240
...
icestr0 = ['ERA_CLOUD_SARTA2/cloudy_airs_l1b_ecm' icestr '.'];
icestr0 = ['ERA_CLOUD_SARTA2/cloudy_airs_l1b_ecm_sarta2_baum_ice.'];

icestr = ['cloudy_airs_l1b_ecm_DEFAULTCLD' icestr '.'];

%%%%%%%%%%%%%%%%%%%%%%%%%

yymmdd00 = [2011 03 11];   %% start from this day
yy0      = yymmdd00(1); 
mm0      = yymmdd00(2); 
dd0      = yymmdd00(3);

iCnt = 0;
while yy0 == 2011 & mm0 == 3 & dd0 == 11
  iCnt = iCnt + 1;
  ix = iaGlist;
