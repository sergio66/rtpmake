...
% clustcmd -L clust_make_ecmcloudrtp_sergio_sarta3_YYMMDD_loopGG.m 001:240
%
% otherwise when happy
% clustcmd -q medium -n 16 -p 4 clust_make_ecmcloudrtp_sergio_sarta3_YYMMDD_loopGG.m 001:240
%
% or
% clustcmd -q long_contrib -n 16 -p 4 clust_make_ecmcloudrtp_sergio_sarta3_YYMMDD_loopGG.m 001:240
...
if codeX == 0
  icestr = '_sarta3_baran_ice';
  run_sarta.sartacloud_code = code0;
elseif codeX == 1
  icestr = '_sarta3_baum_ice';
  run_sarta.sartacloud_code = code1;
elseif codeX == 2
  icestr = '_sarta3_baum_ice_modiswater';
