%% loops over days in month given GGG

% local running to test
% clustcmd -L clust_make_ecmcloudrtp_sergio_sarta_YYMMDD_loopGG_month.m 001:240
%
% otherwise when happy
% clustcmd -q medium -n 64  clust_make_ecmcloudrtp_sergio_sarta_YYMMDD_loopGG_month.m 001:240
%
% or
% clustcmd -q long_contrib -n 64 clust_make_ecmcloudrtp_sergio_sarta_YYMMDD_loopGG_month.m 001:240
%
% for testing, at most 4 nodes 
% clustcmd -q long_contrib -n 32 -P testing clust_make_ecmcloudrtp_sergio_sarta_YYMMDD_loopGG_month.m 001:240

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% March 11, 2011 is my good example
%yymm0  = input('Enter [YYYY MM DD] : ');
...
fprintf(1,'processor doing %4i/%2i granule %3i \n',XYZyymm0(1),XYZyymm0(2),iaGlist);

daysInyear = [31 28 31 30 31 30 31 31 30 31 30 31];
if mod(XYZyymm0(1),4) == 0
  daysInyear(2) = 29;
end
...
for dd = 13 : daysInyear(XYZyymm0(2))
  yymmdd0 = [XYZyymm0 dd];
