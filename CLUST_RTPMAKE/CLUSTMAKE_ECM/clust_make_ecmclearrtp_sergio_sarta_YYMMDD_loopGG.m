...
% clustcmd -L clust_make_ecmclearrtp_sergio_sarta_YYMMDD_loopGG.m 001:240
%
% otherwise when happy
% clustcmd -q medium -n 64 -p 4 clust_make_ecmclearrtp_sergio_sarta_YYMMDD_loopGG.m 001:240
%
% or
% clustcmd -q long_contrib -n 64 -p 4 clust_make_ecmclearrtp_sergio_sarta_YYMMDD_loopGG.m 001:240
...
yymmdd0  = [2013 04 06];   %% for Larrabee testing
...
for ixx = 1 : length(iaGlist)
  ...
  if eeP == 0
    ...
    pa = {{'profiles','rtime','seconds since 1958'}};   %% used to be 1993
    ...
    [h,ha,p,pa] = rtpadd_ecmwf_data(h,ha,p,pa,clrfields); %%% add on ecm
    p0 = p;
