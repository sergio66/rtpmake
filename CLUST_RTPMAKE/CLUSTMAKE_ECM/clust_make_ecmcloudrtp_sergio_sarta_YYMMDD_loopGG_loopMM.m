...
% clustcmd -L clust_make_ecmcloudrtp_sergio_sarta_YYMMDD_loopGG.m 001:240
%
% otherwise when happy
% clustcmd -q medium -n 64 -p 4 clust_make_ecmcloudrtp_sergio_sarta_YYMMDD_loopGG_loopMM.m 001:240
%
% or
% clustcmd -q long_contrib -n 64 -p 4 clust_make_ecmcloudrtp_sergio_sarta_YYMMDD_loopGG_loopMM.m 001:240
...
yymmdd00  = [2011 03 11];   %% for JGR paper
yymmdd00  = [2012 09 20];   %% for SNO with CrIS

yymmdd00  = [2011 01 11];   %% for JGR paper ---> loops on mm, keeping yy dd the same
