...
% clustcmd -L clust_make_ecmcloudrtp_sergio_sarta_YYMMDD_loopGG_loop16daysREV.m 001:240
%
% otherwise when happy
% clustcmd -q medium -n 64 -p 4 clust_make_ecmcloudrtp_sergio_sarta_YYMMDD_loopGG_loop16daysREV.m 001:240
%
% or
% clustcmd -q long_contrib -n 64 -p 4 clust_make_ecmcloudrtp_sergio_sarta_YYMMDD_loopGG_loop16daysREV.m 001:240
...
yymmdd00 = [2007 12 24];   %% start going back from this day
yy0      = yymmdd00(1); 
mm0      = yymmdd00(2); 
dd0      = yymmdd00(3);
