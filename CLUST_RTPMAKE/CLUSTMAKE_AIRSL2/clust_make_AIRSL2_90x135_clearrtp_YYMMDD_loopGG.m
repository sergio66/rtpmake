...
for ixx = 1 : length(iaGlist)
  ...
  if iL2CldType == -1
    fnameOUT= [dirOUT 'allfov_clear_airs_cloudNprofL2data.' ystr '.' mstr '.' dstr '.' gstr '_v6.rtp'];
  elseif iL2CldType == +1
    fnameOUT= [dirOUT 'allfov_clear_airs_cloudNprofL2data_Joel.' ystr '.' mstr '.' dstr '.' gstr '_v6.rtp'];
  end
