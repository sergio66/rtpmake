...
%% same as clust_make_eracloudrtp_sergio_sarta_YYMMDD_loopGG.m except we SEPARET ice N water clouds
%% using run_sarta.ice_water_separator = 440; 

% local running to test
% clustcmd -L clust_make_eracloudrtp_sergio_sarta2_YYMMDD_loopGG.m 001:240
%
% otherwise when happy
% clustcmd -q medium -n 16 -p 2 clust_make_eracloudrtp_sergio_sarta2_YYMMDD_loopGG.m 001:240
%
% or
% clustcmd -q long_contrib -n 16 -p 4 clust_make_eracloudrtp_sergio_sarta2_YYMMDD_loopGG.m 001:240
