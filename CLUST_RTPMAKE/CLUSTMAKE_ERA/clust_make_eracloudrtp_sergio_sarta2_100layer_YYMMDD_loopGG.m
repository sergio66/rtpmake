...
%%
%% same as clust_make_eracloudrtp_sergio_sarta_YYMMDD_loopGG.m except we SEPARATE ice N water clouds
%% using run_sarta.ice_water_separator = 440; 
%% same as clust_make_eracloudrtp_sergio_sarta2_YYMMDD_loopGG.m except we use 100 layer code

% local running to test
% clustcmd -L clust_make_eracloudrtp_sergio_sarta2_100layer__YYMMDD_loopGG.m 001:240
%
% otherwise when happy
% clustcmd -q medium -n 32 -p 4 clust_make_eracloudrtp_sergio_sarta2_100layer__YYMMDD_loopGG.m 001:240
%
% or
% clustcmd -q long_contrib -n 32 -p 4 clust_make_eracloudrtp_sergio_sarta2_100layer__YYMMDD_loopGG.m 001:240
