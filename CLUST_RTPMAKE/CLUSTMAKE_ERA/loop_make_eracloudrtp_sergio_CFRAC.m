...
rCNGWATiceMult = 1.0; rCPSIZEiceMult = 1.0;
%%%%%%%%%%%%%%%%%%%%%%%%%
...
for ix = 1 : iCnt
  ...
  %fnamex = [fnamex ystr '_' mstr '_' dstr '_' gstr '.rtp'];  %% orig before July 2012
  %fnamex = [fnamex '0.375cut_' ystr '_' mstr '_' dstr '_' gstr '.rtp'];  %% test after  July 2012
  %fnamex = [fnamex '0.425cut_' ystr '_' mstr '_' dstr '_' gstr '.rtp'];  %% test after  July 2012
  fnamex = [fnamex '0.625cut_' ystr '_' mstr '_' dstr '_' gstr '.rtp'];  %% test after  July 2012
