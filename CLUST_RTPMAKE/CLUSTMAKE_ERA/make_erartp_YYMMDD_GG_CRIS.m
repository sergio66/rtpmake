...
addpath /asl/matlab2012/cris/readers/
addpath /asl/matlab2012/science
...
warning off    %% else it cries about /asl/matlab/ instead of /asl/matlab2012 or matlib
...
fnamePaul= [fnamePaul 'sergio_cris_l1c.' ystr '.' mstr '.' dstr '.' gstr '.rtp'];
eeP = exist(fnamePaul);
